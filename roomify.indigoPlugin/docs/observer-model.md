...
Roomify includes an optional Observer device that provides visibility into plugin-wide state and activity.
...
The Observer exists above those rooms and represents information that applies to the plugin as a whole.
