...
Modified versions of Roomify must:

- Clearly indicate changes have been made
- Remain under the same Roomify Community License v1.0
- Provide access to corresponding source code when distributed
- Preserve original attribution notices
